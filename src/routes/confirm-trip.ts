        ...
        const message = await mail.sendMail({
          ...
          html: `
           <div style="font-family: sans-serif; font-size: 16px; line-height: 1.6;">
                <p>Você foi convidado(a) de uma viagem para <strong>${trip.destination}</strong> nas datas de <strong>${formattedTripStartDate}</strong> até <strong>${formattedTripEndDate}</strong>.</p>
                <p></p>
